...
class PremiereLauncher(SoftwareLauncher):
    ...
    EXECUTABLE_MATCH_TEMPLATES = {
        "darwin": "/Applications/Adobe Premiere Pro CC {version}/Adobe Premiere Pro {version_back}.app",
        "win32": "C:/Program Files/Adobe/Adobe Premiere Pro {version}/Adobe Premiere Pro.exe",
    }
